...
//----< return first file name that exists else "" >-------------------

std::string File::selectFile(const std::string& file1, const std::string& file2, bool showCurrPath)
{
  if(showCurrPath)
  {
  ...
  if(File::exists(file1))
    return Path::getFullFileSpec(file1);
  else if(File::exists(file2))
    return Path::getFullFileSpec(file2);
  return "";
}
//----< constructor >--------------------------------------------------
...
//----< return first valid path else empty string >------------------------

std::string Path::selectPath(const std::string& path1, const std::string& path2, bool showCurrPath)
{
  if(showCurrPath)
    std::cout << Directory::getCurrentDirectory() << "\n  ";
...
//----< FileSystem Constructors and Destructors >--------------------------------------------------
...
int main(int argc, char* argv[])
{
  ...
  std::string test2 = "../filesystemdemo/test.txt";
  std::string result = File::selectFile(test1, test2);
  if(result != "")
  {
    std::cout << "\n  result of File::selectFile(" << test1 << ", " << test2 << ") is:";    
    std::cout << "\n  " << result;
  }
  else
    std::cout << "\n  File::selectFile(" << test1 << ", " << test2 << ") failed";
  std::cout << "\n";
